import 'package:douddyv1/features/home/screens/game_selection_screen.dart';
import 'package:douddyv1/features/home/screens/story_video_screen.dart';
...
class NumbersScreen extends StatelessWidget {
  final int number;
  const NumbersScreen(this.number, {super.key});
                      ...
                      children: [
                        _MainChoiceCard(
                          ...
                          onTap: () {
                            ...
                            Navigator.of(context).push(MaterialPageRoute(builder: (_) =>  GameSelectionScreen( number :number,)));
                          },
                        ),
                        _MainChoiceCard(
                          width: cardWidth,
                          ...
                          onTap: () {
                            HapticFeedback.lightImpact();
                            Navigator.of(context).push(MaterialPageRoute(builder: (_) =>  StoryVideoScreen(number :number)));
                          },
                        ),
                      ],
                    ),
